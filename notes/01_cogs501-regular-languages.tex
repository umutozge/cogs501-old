...
\begin{uexample}
Let us write a regular expression for the set of strings that consist of
...
% \section*{Self study}
% 
% \cite{sudkamp97}, Chapter 2 covers most of the material here. Beware that the
% book uses `$\lambda$' where we use `$\epsilon$'.

% \bibliographystyle{natgig}
% \bibliography{ozge.bib}
\end{document}
